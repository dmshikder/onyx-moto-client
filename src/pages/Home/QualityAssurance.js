...
const QualityAssurance = () => {
  ...
  <div id="slid1" className="carousel-item flex flex-col relative w-full">
    <img src="https://i.ibb.co/CJVW3Dn/s04-img1.jpg"  alt='pic' className="w-full" />
    <p className='font-bold text-center'>Design & Development</p>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slid4" className="btn btn-circle">❮</a> 
      <a href="#slid2" className="btn btn-circle">❯</a>
    </div>
  </div> 
  <div id="slid2" className="carousel-item flex flex-col relative w-full">
    <img src="https://i.ibb.co/sjbQMVN/s04-img2.jpg" alt='pic' className="w-full" />
    <p className='font-bold text-center'>Sample checking before mass production</p>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slid1" className="btn btn-circle">❮</a> 
      <a href="#slid3" className="btn btn-circle">❯</a>
    </div>
  </div> 
  <div id="slid3" className="carousel-item flex flex-col relative w-full">
    <img src="https://i.ibb.co/C9FWVXz/s04-img4.jpg" alt='pic' className="w-full" />
  ...
  <div id="slid4" className="carousel-item flex flex-col relative w-full">
    <img src="https://i.ibb.co/gdnpKs6/s04-img3.jpg" alt='pic' className="w-full" />
